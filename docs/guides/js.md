...
```
function addUser () {}     // ✓ ok
function handleClick () {}  // ✗ avoid
function submitForm () {}  // ✗ avoid
```
...
## 验证插件
验证插件: <a target="_blank" href="https://eslint.org/">eslint</a>
<br>
验证规范:	<a target="_blank" href="https://standardjs.com">eslint-standard规范</a>
<br>
通过标准: eslint插件无报错提示
...
如需添加忽略目录，请在根目录下添加.eslintignore文件
